...
Fs = 1/Ts; %[Hz]
%------------------
frecuencias = [30 65 82.5 100]';
alturas1 = nivel1Beta;
alturas2 = nivel3Beta;
alturas3 = nivel4Beta;
alturas4 = nivel5Beta;
h_datas = struct('alturas1',alturas1,'alturas2',alturas2,'alturas3',alturas3,'alturas4',alturas4);
limites = [[60 30];[60 30];[60 30];[60 30]];
...
for i=1:length(frecuencias)
    ...
    [auxH, auxT] = myFilt2(subMuestH, limites(i,1), limites(i,2));
...
volumenesFiltrados = struct('v1',[],'v2',[],'v3',[],'v4',[],'v5',[]);
