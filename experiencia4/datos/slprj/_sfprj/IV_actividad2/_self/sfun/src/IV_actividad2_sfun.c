  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==3) {
    c3_IV_actividad2_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3029621412U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(415476565U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3406128567U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(973516619U);
      ...
      switch (chartFileNumber) {
       ...
       case 3:
        {
          extern void sf_c3_IV_actividad2_get_check_sum(mxArray *plhs[]);
          sf_c3_IV_actividad2_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2686549701U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1582201005U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(121347863U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2737300852U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "JwIkaTTMTNOzGdLxqej91E") == 0) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "pd3K2Rez4KBD4oz7zYuNhE") == 0) {
          extern mxArray *sf_c3_IV_actividad2_get_autoinheritance_info(void);
          plhs[0] = sf_c3_IV_actividad2_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        extern const mxArray
          *sf_c3_IV_actividad2_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c3_IV_actividad2_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
