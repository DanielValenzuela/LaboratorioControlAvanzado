...
static const char * c2_debug_family_names[5] = { "var", "nargin", "nargout",
  "varUpdate", "varUpdated" };
...
static real_T c2_emlrt_marshallIn(SFc2_controladorLQRInstanceStruct
  *chartInstance, const mxArray *c2_varUpdated, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_controladorLQRInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_controladorLQRInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_controladorLQRInstanceStruct
  ...
  (SFc2_controladorLQRInstanceStruct *chartInstance)
{
  ...
  real_T *c2_varUpdated;
  c2_varUpdated = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2), FALSE);
  c2_hoistedGlobal = *c2_varUpdated;
  c2_u = c2_hoistedGlobal;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_controladorLQR;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_varUpdated = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c2_u, 0)), "varUpdated");
  chartInstance->c2_is_active_c2_controladorLQR = c2_d_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  real_T c2_varUpdated;
  real_T *c2_b_varUpdate;
  real_T *c2_b_varUpdated;
  c2_b_varUpdated = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_varUpdate = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c2_b_varUpdate, 0U);
  _SFD_DATA_RANGE_CHECK(*c2_b_varUpdated, 1U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_b_varUpdate;
  c2_varUpdate = c2_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 5U, 5U, c2_debug_family_names,
    c2_debug_family_var_map);
  sf_debug_symbol_scope_add_eml_importable(&c2_var, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_varUpdate, 3U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_varUpdated, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 3);
  if (CV_EML_IF(0, 1, 0, c2_varUpdate == 1.0)) {
  ...
  if (CV_EML_IF(0, 1, 1, c2_varUpdate == 1.0)) {
  ...
  *chartInstance, const mxArray *c2_varUpdated, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_varUpdated),
    &c2_thisId);
  sf_mex_destroy(&c2_varUpdated);
  return c2_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_varUpdated;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_controladorLQRInstanceStruct *chartInstance;
  chartInstance = (SFc2_controladorLQRInstanceStruct *)chartInstanceVoid;
  c2_varUpdated = sf_mex_dup(c2_mxArrayInData);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3617422474U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3272505864U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2096839131U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2180413040U);
}
...
mxArray *sf_c2_controladorLQR_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("CCilBA3vQA0dUuMNFvaBrH");
...
static const mxArray *sf_get_sim_state_info_c2_controladorLQR(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"varUpdated\",},{M[8],M[0],T\"is_active_c2_controladorLQR\",}}"
  };
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(_controladorLQRMachineNumber_,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"varUpdate");
          _SFD_SET_DATA_PROPS(1,2,0,1,"varUpdated");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,54,72,95,124);
        _SFD_CV_INIT_EML_IF(0,1,1,129,146,175,211);
...

        {
          ...
          real_T *c2_varUpdated;
          c2_varUpdated = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_varUpdate = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c2_varUpdate);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_varUpdated);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c2_controladorLQR(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4165181560U));
  ssSetChecksum1(S,(2715788690U));
  ssSetChecksum2(S,(2583772047U));
  ssSetChecksum3(S,(3698447244U));
