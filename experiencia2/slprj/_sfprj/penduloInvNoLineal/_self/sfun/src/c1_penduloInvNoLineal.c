...
static void initialize_c1_penduloInvNoLineal
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance);
static void initialize_params_c1_penduloInvNoLineal
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance);
static void enable_c1_penduloInvNoLineal(SFc1_penduloInvNoLinealInstanceStruct
  *chartInstance);
static void disable_c1_penduloInvNoLineal(SFc1_penduloInvNoLinealInstanceStruct *
  chartInstance);
static void c1_update_debugger_state_c1_penduloInvNoLineal
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_penduloInvNoLineal
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance);
static void set_sim_state_c1_penduloInvNoLineal
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_penduloInvNoLineal(SFc1_penduloInvNoLinealInstanceStruct
  *chartInstance);
static void sf_c1_penduloInvNoLineal(SFc1_penduloInvNoLinealInstanceStruct
  *chartInstance);
static void initSimStructsc1_penduloInvNoLineal
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_penduloInvNoLinealInstanceStruct
  *chartInstance, const mxArray *c1_y, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_penduloInvNoLinealInstanceStruct
...
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_penduloInvNoLinealInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_penduloInvNoLineal, const
  char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_penduloInvNoLinealInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_penduloInvNoLinealInstanceStruct
  *chartInstance);
  ...
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_penduloInvNoLineal = 0U;
}
  ...
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_penduloInvNoLineal;
  ...
  (SFc1_penduloInvNoLinealInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_y = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "y");
  chartInstance->c1_is_active_c1_penduloInvNoLineal = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_penduloInvNoLineal");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_penduloInvNoLineal(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_penduloInvNoLinealInstanceStruct *chartInstance;
  chartInstance = (SFc1_penduloInvNoLinealInstanceStruct *)chartInstanceVoid;
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_penduloInvNoLineal), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_penduloInvNoLineal);
  return c1_y;
}
...
static const mxArray *sf_get_sim_state_info_c1_penduloInvNoLineal(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_penduloInvNoLineal\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_penduloInvNoLineal_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_penduloInvNoLinealInstanceStruct *chartInstance;
    chartInstance = (SFc1_penduloInvNoLinealInstanceStruct *) ((ChartInfoStruct *)
...
{
  chart_debug_initialization(((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInstanceVar);
  initialize_c1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_penduloInvNoLineal(void *chartInstanceVar)
{
  enable_c1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_penduloInvNoLineal(void *chartInstanceVar)
{
  disable_c1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_penduloInvNoLineal(void *chartInstanceVar)
{
  sf_c1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_penduloInvNoLineal(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_penduloInvNoLineal
    ((SFc1_penduloInvNoLinealInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_penduloInvNoLineal();/* state var info */
...
extern void sf_internal_set_sim_state_c1_penduloInvNoLineal(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_penduloInvNoLineal(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_penduloInvNoLineal(S);
}

static void sf_opaque_set_sim_state_c1_penduloInvNoLineal(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_penduloInvNoLineal(S, st);
}

static void sf_opaque_terminate_c1_penduloInvNoLineal(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_penduloInvNoLinealInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_penduloInvNoLineal((SFc1_penduloInvNoLinealInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_penduloInvNoLineal(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_penduloInvNoLineal
      ((SFc1_penduloInvNoLinealInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_penduloInvNoLineal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_penduloInvNoLineal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_penduloInvNoLineal(SimStruct *S)
{
  SFc1_penduloInvNoLinealInstanceStruct *chartInstance;
  chartInstance = (SFc1_penduloInvNoLinealInstanceStruct *)malloc(sizeof
    (SFc1_penduloInvNoLinealInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_penduloInvNoLinealInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_penduloInvNoLineal;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_penduloInvNoLineal;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_penduloInvNoLineal;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_penduloInvNoLineal;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_penduloInvNoLineal;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_penduloInvNoLineal;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_penduloInvNoLineal;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_penduloInvNoLineal;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_penduloInvNoLineal;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_penduloInvNoLineal;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_penduloInvNoLineal;
...
void c1_penduloInvNoLineal_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_penduloInvNoLineal(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_penduloInvNoLineal(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_penduloInvNoLineal(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_penduloInvNoLineal_method_dispatcher.\n"
