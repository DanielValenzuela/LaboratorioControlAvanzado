...
static void initialize_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void initialize_params_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void enable_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void disable_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void set_sim_state_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance, const mxArray
   *c8_st);
static void finalize_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void sf_c8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void initSimStructsc8_modeloNoLinealEcuaciones
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_modeloNoLinealEcuacionesInstanceStruct
  *chartInstance, const mxArray *c8_y, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_modeloNoLinealEcuacionesInstanceStruct *
  chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[13]);
static void c8_eml_scalar_eg(SFc8_modeloNoLinealEcuacionesInstanceStruct
  *chartInstance);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_c_emlrt_marshallIn(SFc8_modeloNoLinealEcuacionesInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_d_emlrt_marshallIn(SFc8_modeloNoLinealEcuacionesInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_modeloNoLinealEcuaciones,
  const char_T *c8_identifier);
static uint8_T c8_e_emlrt_marshallIn(SFc8_modeloNoLinealEcuacionesInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_modeloNoLinealEcuacionesInstanceStruct
  *chartInstance);
  ...
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_modeloNoLinealEcuaciones = 0U;
}
  ...
  (SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance)
{
  ...
  c8_b_hoistedGlobal = chartInstance->c8_is_active_c8_modeloNoLinealEcuaciones;
   ...
   *c8_st)
{
  ...
  *c8_y = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 0)),
    "y");
  chartInstance->c8_is_active_c8_modeloNoLinealEcuaciones =
    c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
    "is_active_c8_modeloNoLinealEcuaciones");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_modeloNoLinealEcuaciones(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance;
  chartInstance = (SFc8_modeloNoLinealEcuacionesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c8_modeloNoLinealEcuaciones_get_eml_resolved_functions_info
  (void)
{
  ...
  const char_T *c8_identifier)
{
  ...
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_modeloNoLinealEcuaciones), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_modeloNoLinealEcuaciones);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_modeloNoLinealEcuaciones_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_modeloNoLinealEcuaciones_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_modeloNoLinealEcuaciones(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c8_modeloNoLinealEcuaciones\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_modeloNoLinealEcuaciones_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_modeloNoLinealEcuaciones(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_modeloNoLinealEcuacionesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_modeloNoLinealEcuaciones
    ((SFc8_modeloNoLinealEcuacionesInstanceStruct*) chartInstanceVar);
  initialize_c8_modeloNoLinealEcuaciones
    ((SFc8_modeloNoLinealEcuacionesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_modeloNoLinealEcuaciones(void *chartInstanceVar)
{
  enable_c8_modeloNoLinealEcuaciones
    ((SFc8_modeloNoLinealEcuacionesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_modeloNoLinealEcuaciones(void *chartInstanceVar)
{
  disable_c8_modeloNoLinealEcuaciones
    ((SFc8_modeloNoLinealEcuacionesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_modeloNoLinealEcuaciones(void *chartInstanceVar)
{
  sf_c8_modeloNoLinealEcuaciones((SFc8_modeloNoLinealEcuacionesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_modeloNoLinealEcuaciones
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_modeloNoLinealEcuaciones
    ((SFc8_modeloNoLinealEcuacionesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_modeloNoLinealEcuaciones();/* state var info */
...
extern void sf_internal_set_sim_state_c8_modeloNoLinealEcuaciones(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_modeloNoLinealEcuaciones
    ((SFc8_modeloNoLinealEcuacionesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_modeloNoLinealEcuaciones
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_modeloNoLinealEcuaciones(S);
}

static void sf_opaque_set_sim_state_c8_modeloNoLinealEcuaciones(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c8_modeloNoLinealEcuaciones(S, st);
}

static void sf_opaque_terminate_c8_modeloNoLinealEcuaciones(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_modeloNoLinealEcuacionesInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_modeloNoLinealEcuaciones
      ((SFc8_modeloNoLinealEcuacionesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_modeloNoLinealEcuaciones
    ((SFc8_modeloNoLinealEcuacionesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_modeloNoLinealEcuaciones(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_modeloNoLinealEcuaciones
      ((SFc8_modeloNoLinealEcuacionesInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_modeloNoLinealEcuaciones(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_modeloNoLinealEcuaciones(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_modeloNoLinealEcuaciones(SimStruct *S)
{
  SFc8_modeloNoLinealEcuacionesInstanceStruct *chartInstance;
  chartInstance = (SFc8_modeloNoLinealEcuacionesInstanceStruct *)malloc(sizeof
    (SFc8_modeloNoLinealEcuacionesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_modeloNoLinealEcuacionesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_modeloNoLinealEcuaciones;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_modeloNoLinealEcuaciones;
...
void c8_modeloNoLinealEcuaciones_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_modeloNoLinealEcuaciones(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_modeloNoLinealEcuaciones(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_modeloNoLinealEcuaciones(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_modeloNoLinealEcuaciones_method_dispatcher.\n"
