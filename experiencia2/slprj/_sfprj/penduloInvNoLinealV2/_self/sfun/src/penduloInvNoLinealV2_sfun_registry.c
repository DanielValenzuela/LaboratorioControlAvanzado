...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_penduloInvNoLinealV2_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_penduloInvNoLinealV2_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_penduloInvNoLinealV2_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "penduloInvNoLinealV2") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_penduloInvNoLinealV2_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_penduloInvNoLinealV2_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "penduloInvNoLinealV2") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_penduloInvNoLinealV2_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_penduloInvNoLinealV2_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"penduloInvNoLinealV2")) {
    return(sf_penduloInvNoLinealV2_method_dispatcher(simstructPtr,
...
extern void penduloInvNoLinealV2_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    penduloInvNoLinealV2_terminator();
    sf_debug_terminate();
  }
...
extern void penduloInvNoLinealV2_initializer(void);
extern void penduloInvNoLinealV2_register_exported_symbols(SimStruct* S);
extern void penduloInvNoLinealV2_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  penduloInvNoLinealV2_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      penduloInvNoLinealV2_debug_initialize();
    }

    penduloInvNoLinealV2_initializer();
  }
