...
#include "nonLinearOpenLoop_sfun.h"
#include "c2_nonLinearOpenLoop.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "nonLinearOpenLoop_sfun_debug_macros.h"
...
static void initialize_c2_nonLinearOpenLoop(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance);
static void initialize_params_c2_nonLinearOpenLoop
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance);
static void enable_c2_nonLinearOpenLoop(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance);
static void disable_c2_nonLinearOpenLoop(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_nonLinearOpenLoop
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_nonLinearOpenLoop
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance);
static void set_sim_state_c2_nonLinearOpenLoop
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_nonLinearOpenLoop(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance);
static void sf_c2_nonLinearOpenLoop(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_nonLinearOpenLoop
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance);
static void initSimStructsc2_nonLinearOpenLoop
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance, const mxArray *c2_phi4, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[15]);
static real_T c2_power(SFc2_nonLinearOpenLoopInstanceStruct *chartInstance,
  real_T c2_a);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_nonLinearOpenLoop, const
  char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_nonLinearOpenLoopInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_nonLinearOpenLoop = 0U;
}
  ...
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance)
{
  ...
  c2_e_hoistedGlobal = chartInstance->c2_is_active_c2_nonLinearOpenLoop;
  ...
  (SFc2_nonLinearOpenLoopInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_phi4 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    3)), "phi4");
  chartInstance->c2_is_active_c2_nonLinearOpenLoop = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 4)),
     "is_active_c2_nonLinearOpenLoop");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_nonLinearOpenLoop(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_nonLinearOpenLoop(chartInstance);
  sf_debug_check_for_state_inconsistency(_nonLinearOpenLoopMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_nonLinearOpenLoopInstanceStruct *chartInstance;
  chartInstance = (SFc2_nonLinearOpenLoopInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_nonLinearOpenLoop_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_nonLinearOpenLoop), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_nonLinearOpenLoop);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_nonLinearOpenLoop_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_nonLinearOpenLoop_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_nonLinearOpenLoop(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[10],T\"phi1\",},{M[1],M[11],T\"phi2\",},{M[1],M[12],T\"phi3\",},{M[1],M[13],T\"phi4\",},{M[8],M[0],T\"is_active_c2_nonLinearOpenLoop\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_nonLinearOpenLoop_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_nonLinearOpenLoopInstanceStruct *chartInstance;
    chartInstance = (SFc2_nonLinearOpenLoopInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_nonLinearOpenLoopMachineNumber_,
           2,
           1,
           1,
           9,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_nonLinearOpenLoopMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_nonLinearOpenLoopMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_nonLinearOpenLoopMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration
        (_nonLinearOpenLoopMachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c2_nonLinearOpenLoop(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInstanceVar);
  initialize_c2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_nonLinearOpenLoop(void *chartInstanceVar)
{
  enable_c2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_nonLinearOpenLoop(void *chartInstanceVar)
{
  disable_c2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_nonLinearOpenLoop(void *chartInstanceVar)
{
  sf_c2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_nonLinearOpenLoop(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_nonLinearOpenLoop
    ((SFc2_nonLinearOpenLoopInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_nonLinearOpenLoop();/* state var info */
...
extern void sf_internal_set_sim_state_c2_nonLinearOpenLoop(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_nonLinearOpenLoop(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_nonLinearOpenLoop(S);
}

static void sf_opaque_set_sim_state_c2_nonLinearOpenLoop(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_nonLinearOpenLoop(S, st);
}

static void sf_opaque_terminate_c2_nonLinearOpenLoop(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_nonLinearOpenLoopInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
      chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_nonLinearOpenLoop_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc2_nonLinearOpenLoop((SFc2_nonLinearOpenLoopInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_nonLinearOpenLoop(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_nonLinearOpenLoop(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_nonLinearOpenLoop_optimization_info();
...
static void mdlRTW_c2_nonLinearOpenLoop(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_nonLinearOpenLoop(SimStruct *S)
{
  SFc2_nonLinearOpenLoopInstanceStruct *chartInstance;
  chartInstance = (SFc2_nonLinearOpenLoopInstanceStruct *)malloc(sizeof
    (SFc2_nonLinearOpenLoopInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_nonLinearOpenLoopInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_nonLinearOpenLoop;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_nonLinearOpenLoop;
...
void c2_nonLinearOpenLoop_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_nonLinearOpenLoop(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_nonLinearOpenLoop(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_nonLinearOpenLoop(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_nonLinearOpenLoop_method_dispatcher.\n"
